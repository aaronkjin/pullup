...
import { QRWristbandApi, EventApi } from "../services/apiProvider";
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.infoContainer}>
          ...
          <Text style={styles.infoText}>
            Present this QR code to the event organizer at the entrance. This
            wristband is tied to your SUNet ID and cannot be transferred.
          </Text>
          <Text style={styles.infoText}>
            Keep your phone screen brightness up when showing the QR code for
            better scanning.
          </Text>
        </View>
      </ScrollView>
